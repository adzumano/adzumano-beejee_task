...
<html lang="en">
    ...
    <body class="fixed-nav sticky-footer bg-dark">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/app/admin/add">
                            <i class="fa fa-fw fa-plus"></i>
                            <span class="nav-link-text">Add Task</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/app/admin/tasks">
                            <i class="fa fa-fw fa-list"></i>
                            <span class="nav-link-text">Tasks</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/app/admin/logout">
        ...
        <script type="text/javascript" src="../public/scripts/form_success.js"></script>
        <script src="../public/scripts/task_datatable.js"></script>
    </body>
</html>